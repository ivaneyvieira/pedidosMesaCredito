...
data class AnaliseCredito(
  val requestIdentification: String,
  @Json(name = "processId")
  val processID: String,
  @Json(name = "prospectId")
...
data class Data(
  val perfilDasPessoas: PerfilDasPessoas,
...
data class Parametros(
  val paramConsideraConsultasProprias: Boolean,
...
data class IndicadoresGeradosRegra(
  val regrasAplicadas: RegrasAplicadas,
...
data class ListaDeGrafia(
  val nomeEmpresa: String
)

data class RegrasAplicadas(
  val regraIdadeMinima: String,
...
data class PerfilDasPessoas(
  val proponente: Proponente
)
...
data class Servicos(
  val spcbrasil: Spcbrasil,
  val receita: Receita
)

data class Receita(
  val situacaoPf: SituacaoPf
)

data class SituacaoPf(
  val id: String,
...
data class ConsultaRealizada(
  val origemAssociado: String,
  val uf: String,
...
data class Consumidor(
  val consumidorPessoaFisica: ConsumidorPessoaFisica
)

data class ConsumidorPessoaFisica(
  val cpf: String,
...
data class ResumoRendaPresumidaSpc(
  val quantidadeTotal: Long,
  val valorTotal: Long
)

data class UltimoEnderecoInformado(
  val endereco: Endereco
)
...
data class Bureau(
  @Json(name = "spcbrasil-spc")
  val spcbrasilSpc: Long,

  @Json(name = "receita-situacaoPf")
  val receitaSituacaoPf: Long
)
