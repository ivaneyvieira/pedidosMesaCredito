...
data class Contrato(val loja: String, val contrato: String, val nomeCliente: String, val codigoCliente: String,
               val enderecoCliente: String, val nomeAvalista: String, val codigoAvalista: String,
